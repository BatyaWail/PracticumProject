    ...
    for (let i = 0; i < this.employeeRoles.length; i++) {
      for (let j = 0; j < this.rolesList.length; j++) {
        if (this.employeeRoles[i].roleName == this.rolesList[j].roleName) {
          // this.employeeRoleResult[count].roleId=this.rolesList[j].id
          // this.employeeRoleResult[count].isManagementRole=this.employeeRoles[i].isManagementRole
          // this.employeeRoleResult[count].entryDate=this.employeeRoles[i].entryDate
          // count++;
          ...
          // this.employeeRoleResult.push(new EmployeeRolePostModel()
          // {roleId=this.rolesList[j].id, isManagementRole=this.employeeRoles[i].isManagementRole})
          // this.employeeRolesResult.push()
          // let employee1: EmployeeRole = new EmployeeRole();
          // // employee1.employeeId = this.rolesList[j].id
          // employee1.roleId = this.rolesList[j].id
          // employee1.isManagementRole =this.employeeRoles[i].isManagementRole
          // employee1.entryDate = this.employeeRoles[i].entryDate
          // // employee1.entryDate=this.employeeRoles[i].entryDate!=null?this.employeeRoles[i].entryDate:new Date()
          // this.employee.employeeRoles.push(employee1)
        }
      }

      // this.employee.employeeRoles.push(new EmployeeRole(){roleId=this.employeeRoles[index]})
